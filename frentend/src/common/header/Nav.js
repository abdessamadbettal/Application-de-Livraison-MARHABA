        ...
        <ul className="mainmenu">
            <li className="">
                ...
                {/* <ul className="submenu">
                    ...
                    <li><Link to="/home-jami3a">Home jami3a</Link></li>
            ...
            <li className="has-droupdown">
                ...
                <ul className="submenu">
                    ...
                    <li><Link to="/course-details-jami3a/2">Course Details ja</Link></li>
            ...
            <li className="">
                <Link to="/contacter-nous">Contact nous</Link>
                {/* <ul className="submenu">
                    <li><Link to="/contacter-nous">Contact Nous</Link></li>
