                ...
                <div className="eduvibe-widget">
                    <div className="video-area">
                        <div className="thumbnail video-popup-wrapper">
                            <img className="radius-small w-100" src={`${process.env.PUBLIC_URL}/images/pdfimg/test.jpg`} alt="Course Video Thumb" />
                    ...
                    <div className="eduvibe-widget-details mt--35">
                        <div className="widget-content">
                            ...
                            <div className="read-more-btn mt--45">
                                <a href="#" className="edu-btn btn-bg-alt w-100 text-center text-decoration-none">
                                    Play en ligne {/* { data.price === '0' ? 'Free' : data.price } */}
                                </a>
                            </div>
                            <div className="read-more-btn mt--15">
                                <a href="#" className="edu-btn w-100 text-center text-decoration-none">Télécharger</a>
                            </div>
                            <div className="read-more-btn mt--30 text-center">
                                <div className="eduvibe-post-share">
                                    <span>partager sur : </span>
                                    <a className="linkedin text-decoration-none" href="#"><i className="icon-linkedin "></i></a>
                                    <a className="facebook text-decoration-none" href="#"><i className="icon-Fb "></i></a>
                                    <a className="twitter text-decoration-none" href="#"><i className="icon-Twitter "></i></a>
                                    <a className="youtube text-decoration-none" href="#"><i className="icon-youtube "></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
